#Aplicamos el codigo de apertura de camara como base
...
print("Presiona 'q' para salir | 'g' = gris | 'b' = blur | 'c' = bordes | 'n' = normal")

#Establecemos el filtro por defecto
filtro = "normal"
...
while True:
    ...
    if filtro == "gris":
        ...
        frame = cv2.GaussianBlur(bgr_frame,(15,15),0)
    elif filtro == "canny":
        frame = cv2.Canny(bgr_frame,100,200)
    else:
        frame = bgr_frame


    #Mostramos ahora si la imagen o frame convertido en una ventana como lo hacemos usualmente
    cv2.imshow("VIDEO HQ con filtros",frame)
